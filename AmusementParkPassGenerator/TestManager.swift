    ...
    func runTests() {
        ...
        let information7 = EntrantInformation(firstName: "Gavin", lastName: "Jones", streetAddress: "35 Test Street", city: "Barrie", state: "Ontario", zipCode: "K5T 7G5", socialSecurityNumber: 458, dateOfBirth: birthDate3)
                ...
                do {
                    ...
                    dump(child1)
                    dump(ObjectIdentifier(child1.pass).hashValue)
                    child1identifier = ObjectIdentifier(child1.pass).hashValue
                ...
                do {
                    ...
                    dump(manager1)
                    dump(ObjectIdentifier(manager1.pass).hashValue)
                    print(ObjectIdentifier(manager1.pass).hashValue == child1identifier)        //This shouldn't be true!!??!!
